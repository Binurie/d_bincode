...
| `Int8List`, etc.         | `writeInt8List`, `writeUint16List`, etc.            | `readInt8List`, `readUint16List`, etc.              | Length-prefixed (u64) + typed data                     |
| `Float32List`, `Float64List` | `writeFloat32List`, `writeFloat64List`          | `readFloat32List`, `readFloat64List`                | Length-prefixed (u64) + typed data                     |
...
| `BincodeCodable?` (Nested) | `writeOptionNestedValueForFixed`, `writeOptionNestedValueForCollection` | `readOptionNestedObjectForFixed`, `readOptionNestedObjectForCollection`Optional nested |
